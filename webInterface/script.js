...
function setup() {
  ...
  altitudeDataLine = new dataLine((5 * displayWidth)/6, dataBeginY, dataEndY, 0, 20, dataStrokeWeight, dataFrameRate, "Altitude(M)", "rgb(0,0,255)");
}
...
function draw() {
  ...
  if (servoAngle > 0) {
	...
	text("Orientation: " + orientationResult, displayWidth/2, displayHeight/2 + displayHeight/11);
  	/******* Orientation ******/
} // End of Draw()